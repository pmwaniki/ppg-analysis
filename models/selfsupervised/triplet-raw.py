...
from pytorch_metric_learning import distances,regularizers
...
partial(permute,n_segments=40,p=1.0),
]
...
optimizer=torch.optim.Adam(params=model.parameters(),lr=enc_lr_ ,weight_decay=enc_l2_,betas=(0.99,0.999))
