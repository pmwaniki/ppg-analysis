...
from pytorch_metric_learning import distances,regularizers,losses
...
configs = {
    ...
    'enc_output_size':tune.choice([32,64,128,512]),
    'representation_size':tune.choice([64,]),
    'batch_size':tune.choice([8,16,32,64,128]),
    'enc_temp':tune.loguniform(0.0001,1),
...
if __name__=="__main__":
    ...
    result = tune.run(
        ...
        num_samples=300,
        # name="Trainer_2020-11-30_16-31-41",
        # resume=True,
        scheduler=scheduler,
